...
def model_forward_wrapper(
    ...
    **kwargs : Any
    ...
    model_out_type0,model_out_type1=model(feats=feats,coors=xyzs,mask=gmasks, edges=adjs,sigmas=sigma)
    #print (model_out_type1.shape)

    return c_skip * xyzs + c_out *model_out_type1 
...
class ConsistencySamplingAndEditing:
    ...
    def __call__(
        ...
        **kwargs : Any
        ...
        print('step_num:', len(sigmas))
        x_dict = {}
        for stp, sigma in enumerate(sigmas):
